...
const styles = StyleSheet.create({
  ...
  messages: { paddingHorizontal: 15, paddingTop: 14, paddingBottom: 22 }, datePill: { alignSelf: 'center', backgroundColor: '#E4E5DF', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 10, marginBottom: 16, marginTop: 2 }, datePillText: { color: palette.muted, fontSize: 9, fontWeight: '700' },
